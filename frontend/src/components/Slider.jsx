...
import Slide_01 from '../images/slide-01.jpg';
import Slide_02 from "../images/slide-02.jpg";
import Slide_03 from "../images/slide-03.jpg";
      ...
      <section class="section-slide">
        <div class="wrap-slick1">
          <div class="slick1">
            ...
            <div
              class="item-slick1"
              style={{ backgroundImage: `url(${Slide_02})` }}
            >
              <div class="container h-full">
                <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                  <div
            ...
            <div
              class="item-slick1"
              style={{ backgroundImage: `url(${Slide_03})` }}
            >
              <div class="container h-full">
                <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                  <div
